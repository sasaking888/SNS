...
## 名前
**ジーナ**（2026-07-10 オーナー命名）。オーナーから「ジーナ」と呼ばれたら秘書のこと。
...
- `shared-board.md` - Claude / Grok 共有ボード（任意。不要なら削除可）

## 共有ボード（任意）
- パス: `secretary/shared-board.md`
- Claude と Grok を併用するとき、作業開始時に読み、重要な進捗・次の一手だけ追記する
- 不要になったらファイル削除で運用終了してよい
